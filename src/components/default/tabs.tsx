...
export const Tabs: (
  props: TabsProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef(
  (
    { value: providedValue, onValueChange, defaultValue, children, ...props },
    ref
  ) => {
...
export const TabsList: (
  props: TabsListProperties & RefAttributes<ComponentInternals>
  ...
  return (
    <Container
      ...
      {...props}
    >
      <DefaultProperties color={colors.mutedForeground}>
        {children}
      </DefaultProperties>
    </Container>
  );
...
export type TabsTriggerProperties = ContainerProperties & {
  disabled?: boolean;
  value: string;
};

export const TabsTrigger: (
  props: TabsTriggerProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef(
...
export const TabsContent: (
  props: TabsContentProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef(({ value, ...props }, ref) => {
