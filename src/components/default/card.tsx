...
export const CardHeader: (
  props: CardHeaderProperties & RefAttributes<ComponentInternals>
...
export const CardContent: (
  props: CardContentProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef((props, ref) => {
...
export const CardFooter: (
  props: CardFooterProperties & RefAttributes<ComponentInternals>
) => ReactNode = forwardRef((props, ref) => {
  return (
    <Container
      flexDirection="row"
